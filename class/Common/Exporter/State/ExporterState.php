...
class ExporterState
{
    ...
    public function init($session_id)
    {
        ...
        $state = self::get_state($this->exporter_id);
        if (!$state) {
            $state = $this->default($session_id);
            $this->set_state($this->exporter_id, $state);
        }
    ...
    public function update($callback)
    {
        ...
        $this->set_state($this->exporter_id, $this->data);
    ...
    public static function wait_for_lock($exporter_id, $user, $callback)
    {
        $result = null;
        if (is_callable($callback)) {
    ...
    function update_importer_stats($stats)
    {
        ...
        $this->data['stats']['rows'] += $stats['rows'];
