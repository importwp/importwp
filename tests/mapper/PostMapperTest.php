...
class PostMapperTest extends WP_UnitTestCase{
    ...
    public function test_exists(){
    	...
    	$slug = 'test-insert';
    	$post_id = wp_insert_post(array('post_title' => 'INSERTED', 'post_name' => $slug, 'post_type' => 'post', 'post_status' => 'publish'));
    ...
    public function test_update(){
    	...
    	$slug = 'test-'.md5(time());
    	$post_id = wp_insert_post(array('post_title' => 'INSERTED',  'post_type' => 'post', 'post_status' => 'publish'));
