...
class JC_XML_Parser extends JC_Parser{
	...
	public function __construct(){
		...
		add_action('jci/output_'.$this->get_name().'_group_settings', array($this, 'output_group_settings'), 10 , 2);
	}
	...
	public function output_general_settings($id){
		...
		echo JCI_FormHelper::text('parser_settings[import_base]', array('label' => 'Base', 'default' => $import_base, 'after' => ' <a href="#" class="base-node-select base">[select]</a>', 'class' => 'jc-importer_general-base' ));
	}
	...
	public function output_group_settings($id, $group){
		...
		echo JCI_FormHelper::text("parser_settings[group][{$group}][base]", array('label' => 'Base', 'default' => $import_base, 'after' => ' <a href="#" class="base-node-select group">[select]</a>', 'class' => 'jc-importer_general-group' ));
	}
