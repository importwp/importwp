		...
		<div id="post-body-content">
			...
			<div id="postbox-container-2" class="postbox-container">
				...
				<div id="pageparentdiv" class="postbox " style="display: block;">
					<div class="handlediv" title="Click to toggle"><br></div><h3 class="hndle"><span>Create Importer</span></h3>
					<div class="inside">
						<?php
						...
						echo JCI_FormHelper::select('template', array( 'options' => get_template_list(), 'label' => 'Template'));

						echo '<h2 class="title">2. Choose Datasource</h2>';
						echo '<p>Select where you wish to import your data from.</p>';
						
						// upload file
						echo JCI_FormHelper::radio('import_type', array('label' => 'Upload' , 'value' => 'upload', 'class' => 'toggle-fields', 'checked' => true));
						

						// get file from url
						echo JCI_FormHelper::radio('import_type', array('label' => 'Remote' , 'value' => 'remote', 'class' => 'toggle-fields'));
						...
						echo JCI_FormHelper::Submit('update', array('class' => 'button button-primary button-large', 'value' => 'Continue'));
						?>
					</div>
				</div>
