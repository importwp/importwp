				...
				<?php if ( file_exists( JCI()->importer->file ) ): ?>
                    ...
                    <div class="form-actions">
						...
						<?php if ( $import_status == 1 ): ?>
                            <a href="#"
                               class="jc-importer_update-run iwp-import-btn__<?php echo $template_type; ?> button-primary">Continue
                                Import</a>
						<?php else: ?>
                            <a href="#"
                               class="jc-importer_update-run iwp-import-btn__<?php echo $template_type; ?> button-primary">Run
                                Import</a>
						<?php endif; ?>
                    </div>
