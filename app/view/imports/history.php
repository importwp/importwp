	...
	<div id="post-body" class="metabox-holder columns-2">
		...
		<div id="post-body-content">
				...
				<table class="wp-list-table widefat fixed posts" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="admin.php?page=jci-importers&import=<?php echo $importer_id; ?>&log=<?php echo $row->version; ?>&action=history">View</a></td>
						</tr>
							<?php endforeach; ?>
						<?php else: ?>
						<tr>
			...
			<div id="postbox-container-2" class="postbox-container">
				...
				<p><a href="admin.php?page=jci-importers&import=<?php echo $importer_id; ?>&action=history">&larr; Back to importer history</a></p>
