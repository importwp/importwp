		...
		if($template == $this->_name){
			...
			jQuery(document).ready(function($){
				...
				$('input[name="jc-importer_template_settings[enable_id]"]').change(function(){
					var elem = $('#jc-importer_field-page-ID').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('input[name="jc-importer_template_settings[enable_order]"]').change(function(){
					var elem = $('#jc-importer_field-page-menu_order').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('input[name="jc-importer_template_settings[enable_password]"]').change(function(){
					var elem = $('#jc-importer_field-page-post_password').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('input[name="jc-importer_template_settings[enable_template]"]').change(function(){
					var elem = $('#jc-importer_field-page-page_template').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('input[name="jc-importer_template_settings[enable_comments]"]').change(function(){
					var elem = $('#jc-importer_field-page-comment_status').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('input[name="jc-importer_template_settings[enable_ping]"]').change(function(){
					var elem = $('#jc-importer_field-page-ping_status').parent();
					if(!$(this).is(':checked')){
						elem.hide();
					}else{
						elem.show();
				...
				$('#jci_page_enable_fields input').trigger('change');
			});
			</script>
			<?php
		}
