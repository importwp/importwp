<div class="wrap jci-addons-page">
	...
	<?php if ( isset( $_GET['action'] ) && $_GET['action'] == 'clear-logs' ): ?>
		<?php if ( isset( $_GET['result'] ) && $_GET['result'] == 1 ): ?><div id="message" class="error_msg warn updated">
            <p>Importer Logs have been cleared</p><?php endif; ?>
        </div><?php endif; ?>
    <a href="<?php echo esc_url( add_query_arg( array( 'action' => 'clear-logs' ), remove_query_arg( 'result' ) ) ); ?>"
       class="button button-primary">Clear Importer Logs</a>
    <br><br>
    <hr>
    ...
    <a href="<?php echo esc_url( add_query_arg( array( 'action' => 'clear-settings' ), remove_query_arg( 'result' ) ) ); ?>"
       class="button button-primary">Clear Settings History</a>
    <br><br>
    <hr>
	...
	<?php if ( isset( $_GET['action'] ) && $_GET['action'] == 'update-db' ): ?>
		<?php if ( isset( $_GET['result'] ) && $_GET['result'] == 1 ): ?><div id="message" class="error_msg warn updated">
            <p>Importer DB has been updated</p><?php endif; ?>
        </div><?php endif; ?>
