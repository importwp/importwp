...
class IWP_Text {
	...
	public function __construct() {
		...
		$this->_default = array(
			...
			'import.permissions.create_filter'         => __( 'Allow / Disallow which fields are imported when a new record is created.', 'iwp' ),
			...
			'import.permissions.label_filter_type'     => __( 'Import', 'iwp' ),
